...
import { useVisibleProject } from "./hooks/useVisibleProject";
...
export function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Concevoir et implémenter une base de données PostgreSQL pour CineNet, un réseau social et forum dédié aux cinéphiles, intégrant gestion des utilisateurs, films, événements, discussions, et un système avancé de recommandations personnalisées selon le profil des utilisateurs.",
      image:
        "https://i.pinimg.com/736x/8c/df/4e/8cdf4ef83b1fdf8dddb43f8a53aa4bb2.jpg",
      technologies: ["SQL", "PostgreSQL", "Python"],
      githubLink: "https://gitlab.com/aden75000/BDD_Cinenet",
      liveLink: null,
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Découvrez mes réalisations en cybersécurité et
            développement, démontrant mes compétences techniques
            et ma passion pour la sécurité informatique.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              animate={isInView ? {
                opacity: 1,
                y: visibleProject === index && isMobile ? -10 : 0,
                scale: visibleProject === index && isMobile ? 1.02 : 1,
                boxShadow: visibleProject === index && isMobile 
              ...
              className={`bg-gray-900 rounded-xl overflow-hidden border transition-all duration-300 group flex flex-col min-h-[350px] md:min-h-[450px] lg:min-h-[520px] ${
                visibleProject === index && isMobile
                  ? "border-green-400/60"
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <motion.span
                      ...
                      className="px-3 py-1 bg-green-400/10 text-green-400 rounded-full text-sm border border-green-400/20 cursor-default"
                    >
                      {tech}
                    </motion.span>
                  ))}
        ...
        >
          ...
          >
            Voir plus de projets sur Gitlab
          </motion.a>
        </motion.div>
      </div>
    </section>
