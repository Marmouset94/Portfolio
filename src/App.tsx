...
export default function App() {
  return (
    <div className="min-h-screen text-white overflow-x-hidden bg-gradient-to-br from-black via-gray-900 to-black relative">
      ...
      <div className="fixed top-1/4 left-1/4 w-96 h-96 bg-green-400/5 rounded-full blur-3xl pointer-events-none animate-pulse"></div>
      <div className="fixed bottom-1/4 right-1/4 w-96 h-96 bg-green-400/5 rounded-full blur-3xl pointer-events-none animate-pulse"></div>
      <FloatingParticles />
